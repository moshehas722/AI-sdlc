...
| Developer persona | `.harness/persona/developer/` | Persona bundle | persona.md, audit.md |
| Designer persona | `.harness/persona/designer/` | Persona bundle | persona.md, audit.md |
| Persona audit command | `.cursor/commands/persona/persona-audit.md` | Slash command | Session scoring and audit history |
| Persona retrospective command | `.cursor/commands/persona/persona-retrospective.md` | Slash command | Extract feedback → `.context/memory/pending/` |
| Persona promote-memory command | `.cursor/commands/persona/persona-promote-memory.md` | Slash command | Promote pending → `.context/memory/<persona>.md` |
...
| Context persona memory (developer) | `.context/memory/developer.md` | Memory | Live developer behavioral learnings |
| Context persona memory (designer) | `.context/memory/designer.md` | Memory | Live designer behavioral learnings |
| Context pending memory (developer) | `.context/memory/pending/developer.md` | Staging | Unapproved developer retrospective insights |
| Context pending memory (designer) | `.context/memory/pending/designer.md` | Staging | Unapproved designer retrospective insights |
